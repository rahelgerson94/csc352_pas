...
void Object3D_update_coords(double length, double width, char* orientation, Coordinate3D origin, Coordinate3D* a, Coordinate3D* b, Coordinate3D* c, Coordinate3D* d);
